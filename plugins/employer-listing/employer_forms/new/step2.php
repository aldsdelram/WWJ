			...
			<div class="form-container">
				...
				<!-- 3 -->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label for="videos[link1]">Link 1:</label> <input class="input-field" name="videos[link1]" type="text">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="videos[link2]">Link 2:</label> <input class="input-field" name="videos[link2]" type="text">
							</div>
						</div>
					</div>
