					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="dropdown-input">
									<input type="text" class="dropdown-data input-field field_of_expertise" name="industry" readonly/>
						...
						<div class="col-xs-12">
							<div class="form-group">
								<div class="selector_tagger" data-selected-name="skills">
									...
									<div class="skills_selected selected_container"></div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input name="expiry_date" class="input-field" type="text" readonly value="<?= $today->format('d/m/Y') ?>">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input name="working_hours" class="input-field" type="text">
							</div>
						</div>
