			...
			<div class="resume-header">
				...
				<ul class="resume-steps">
					...
					<li class="steps <?= ( in_array( $step, array( 1, 2, 3 ) ) ) ? 'active' : '' ?>">
						...
						<?php
							if ($step == 2 || $step == 3) {
								echo "<a href='javascript:history.go(-1)''><label for='step01'>About Me</label></a>";
							}else{
								echo "<label for='step01>About Me</label>";
							}
						?>
					...
					<li class="steps <?= ( in_array( $step, array( 2, 3 ) ) ) ? 'active' : '' ?>">
						...
						<?php
							if ($step == 2 || $step == 3) {
								echo "<a href='javascript:history.go(-1)''><label for='step02'>Availability &amp; Experience</label></a>";
							}else{
								echo "<label for='step02'>Availability &amp; Experience</label>";
							}
						?>
					...
					<li class="steps <?= ( $step == 3 ) ? 'active' : '' ?>">
						...
						<?php
							if ($step == 2 || $step == 3) {
								echo "<a href='javascript:history.go(-1)''><label for='step03'>Skills &amp; Others</label></a>";
							}else{
								echo "<label for='step03'>Skills &amp; Others</label>";
							}
						?>
