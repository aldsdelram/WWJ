...
function view_experience_content(){
	...
	?>
		...
		<div class="row col-xs-12" style="border:none;padding-right: 0px;" align="right">
			<a href="#" style="font-size: 20px;color:red;font-weight:bold">ADD</a>
		</div>
			...
			<?php foreach($work_experiences as $key => $work_experience): ?>
				...
				<div class="row exp--sets">
					...
					<div class="col-xs-12">
						...
						<h2>
							<div class="exp--job-title col-xs-4" style="padding-left: 0px;">
								<?= $work_experience['job'] ?>
							</div>
							<div class="exp--job-title col-xs-4">

							</div>
							<div class="exp--job-title col-xs-4" align="right">
								<a href="<?= home_url('jobseeker/dashboard/profile/edit/experience/?company='.$key) ?>" style="font-size: 20px;">EDIT</a>
								&nbsp|&nbsp
								<a href="#" style="font-size: 20px;">DELETE</a>
							</div>
						</h2>
						...
						<p class="exp--description"><strong class="textcolor--gray">Job Description</strong><br>
					...
					<div class="col-xs-12 exp--miscs">
						...
						<div class="row">
							...
							<div class="col-sm-6"><strong class="textcolor--gray">Years of Stay</strong></div>
						...
						<!-- <div class="row">
							...
							<div class="col-sm-6"><strong class="textcolor--gray">Last Salary:</strong></div>
								...
								<?php if($verification): ?>
									...
									<?php foreach ($ver['firstname'] as $k => $v): ?>
										...
										<div>
											...
											<span style="color:#33F9FF;font-weight:bold"><a class="ref_mail" href="mailto:<?= $ver['email'][$k]?>"><?= $ver['email'][$k]?>1</a></span>
