...
<body>
	...
	<main id="main-wrapper" class="company-profile-template">
				...
				<div class="row">
					...
					<div class="col-sm-8 flex-h-middle">
						<div class="cp--about_texts">
							<h2 style="color: #180d07;" class="oc--section_titles">About Us</h2>
		...
		<!-- 3: OUR SERVICES -->
		<section id="c-profile--our_services" style="background-color: #180d07;">
			<div class="btsp-container">
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="cp--flex-grid">
							...
							<div class="cp--flex_set">
								<div class="cp--flex-image" style="background-image: url('http://preskubbs.com/wwj2/skubbswp/wp-content/uploads/2017/02/testprofilebg.jpg');"></div>
		...
		<section id="c-profile--team_members">
			<div class="btsp-container">
				<div class="row">
					<div class="col-xs-12">
						<h2 style="color: #180d07;" class="oc--section_titles">Team Members</h2>

						<div class="cp--flex-grid">

							<div class="cp--flex_set">
								<div class="cp--flex-image" style="background-image: url('http://preskubbs.com/wwj2/skubbswp/wp-content/uploads/2017/02/testprofilebg.jpg'); border-color: #8d9f31;"></div>
		...
		<section id="c-profile--testimonials">
			<div class="btsp-container">
				<div class="row">
					<div class="col-xs-12">
						<h2 style="color: #180d07; text-align: center;" class="oc--section_titles">Testimonials</h2>
					</div>
				</div>

				<div class="cp--testi_flex">
					...
					<div class="cp--testi_set">
						...
						<div class="cp--testi_image" style="background-image: url('http://preskubbs.com/wwj2/skubbswp/wp-content/uploads/2017/02/testprofilebg.jpg'); border-color: #8d9f31;"></div>
					</div>
